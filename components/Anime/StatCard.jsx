export default function StatCard({ icon, value, field }) {
  return (
    <div className="flex flex-row px-3 py-2 md:px-6 md:py-10 overflow-hidden bg-white hover:bg-gradient-to-br hover:from-[#F2D7D9]  hover:to-[#D3CEDF] rounded-xl shadow-lg duration-300 hover:shadow-2xl group">
      <div className="ml-0">
